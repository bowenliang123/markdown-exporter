...
subcommands=("md_to_codeblock" "md_to_csv" "md_to_docx" "md_to_html" "md_to_html_text" "md_to_ipynb" "md_to_jira" "md_to_json" "md_to_latex" "md_to_md" "md_to_pdf" "md_to_png" "md_to_pptx" "md_to_svg" "md_to_xlsx" "md_to_xml")
